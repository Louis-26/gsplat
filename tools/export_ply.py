...
def export_ply(ckpt_path, save_path):
    ...
    vertex_data['f_dc_0'], vertex_data['f_dc_1'], vertex_data['f_dc_2'] = sh0[:, 0], sh0[:, 1], sh0[:, 2]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Convert 3DGS .pt checkpoints to .ply format.")
